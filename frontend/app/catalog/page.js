...
function CatalogContent() {
  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: '40px', animation: 'fadeInUp 0.6s ease-out' }}>
        <CatalogFilters />
      </div>
      ...
      {loading && (
        <div style={{ textAlign: 'center', padding: '60px 20px' }}>
          <div
            ...
            style={{ width: '80px', height: '80px', borderRadius: '50%', margin: '0 auto 24px' }}
          />
          <p style={{ color: c.textSub, fontSize: '16px' }}>Cargando productos únicos...</p>
        </div>
      )}
